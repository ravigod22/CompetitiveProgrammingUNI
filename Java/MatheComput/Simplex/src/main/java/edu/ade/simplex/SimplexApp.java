...
public class SimplexApp extends JFrame {
    ...
    public SimplexApp() {
        ...
        btnAceptar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Crea la ventana para ingresar la función objetivo y las restricciones
    ...
    private void crearVentanaFuncionObjetivo(int nroVariables, int nroRestricciones) {
        ...
        for (int i = 0; i < nroRestricciones; i++) {
            // Construccion de la forma estandar de las restricciones
        ...
        // Botón para calcular el Simplex
        ...
        btnCalcular.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Obtener valores de la matriz de restricciones
        ...
        // Crear ventana para ingresar la función objetivo y restricciones
        ...
        ventanaFuncionObjetivo.add(btnCalcular); // Agregar el botón de calcular
